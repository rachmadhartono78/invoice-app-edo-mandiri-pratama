...
<div style="margin-bottom: 2rem;">
    ...
    <h1 style="font-size: 1.875rem; font-weight: 800; letter-spacing: -0.025em; margin: 0;">Add New Client</h1>
</div>
...
<div class="card" style="max-width: 700px;">
    <form method="POST" action="{{ route('clients.store') }}">
        ...
        <div style="display: grid; gap: 1.5rem;">
            <!-- Name -->
            <div>
                <label for="name" style="display: block; margin-bottom: 0.5rem; font-weight: 500; font-size: 0.875rem;">Name <span style="color: #ef4444;">*</span></label>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                ...
                <div>
                    <label for="phone" style="display: block; margin-bottom: 0.5rem; font-weight: 500; font-size: 0.875rem;">Phone</label>
            ...
            <!-- Company -->
            <div>
                <label for="company" style="display: block; margin-bottom: 0.5rem; font-weight: 500; font-size: 0.875rem;">Company</label>
            ...
            <!-- Address -->
            <div>
                <label for="address" style="display: block; margin-bottom: 0.5rem; font-weight: 500; font-size: 0.875rem;">Address</label>
                <textarea id="address" name="address" rows="3"
                          style="width: 100%; padding: 0.625rem; border: 1px solid var(--input-border); border-radius: 0.375rem; font-size: 0.95rem; resize: vertical; background: var(--input-bg); color: var(--text-color);"
            ...
            <!-- Notes -->
            <div>
                <label for="notes" style="display: block; margin-bottom: 0.5rem; font-weight: 500; font-size: 0.875rem;">Notes</label>
        ...
        <div style="display: flex; gap: 0.75rem; margin-top: 2rem; padding-top: 1.5rem; border-top: 1px solid var(--border-color);">
            <button type="submit" class="btn btn-primary" style="padding: 0.625rem 1.5rem;">Save Client</button>
