...
<div style="max-width: 800px; margin: 0 auto;">
    ...
    <div style="margin-bottom: 2rem;">
        ...
        <h1 style="font-size: 1.875rem; font-weight: 800; letter-spacing: -0.025em; margin: 0;">Edit Product</h1>
        <p style="color: var(--text-secondary); margin: 0.5rem 0 0 0; font-size: 0.95rem;">Update details for <strong>{{ $product->name }}</strong></p>
    </div>
    ...
    <form action="{{ route('products.update', $product) }}" method="POST">
            ...
            <div style="display: grid; gap: 1.5rem;">
                <div>
                    ...
                    <div style="position: relative;">
                        ...
                        <input type="number" id="price" name="price" value="{{ old('price', $product->price) }}" step="any" required
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="4"
                              ...
                              onfocus="this.style.borderColor='var(--primary-color)';this.style.boxShadow='0 0 0 3px rgba(79,70,229,0.1)'"
                              onblur="this.style.borderColor='';this.style.boxShadow=''">{{ old('description', $product->description) }}</textarea>
        ...
        <div style="display: flex; justify-content: space-between; padding-top: 0.5rem;">
            <form action="{{ route('products.destroy', $product) }}" method="POST" style="margin: 0;" onsubmit="return confirm('Are you sure you want to delete this product?')">
                @csrf
                @method('DELETE')
                <button type="submit" style="display: inline-flex; align-items: center; gap: 0.375rem; padding: 0.625rem 1.25rem; background: transparent; border: 1px solid #fecaca; color: #ef4444; border-radius: 0.375rem; font-weight: 500; font-size: 0.875rem; cursor: pointer; transition: all 0.2s;" onmouseover="this.style.backgroundColor='#fef2f2';this.style.borderColor='#ef4444'" onmouseout="this.style.backgroundColor='transparent';this.style.borderColor='#fecaca'">
